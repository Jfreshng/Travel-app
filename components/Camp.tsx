...
const Camp = () => {
  return (
    <section className="2xl:max-container 2xl:padding-container relative flex flex-col py-10 lg:py-20 lg:mb-10 xl:mb-20">
        <div className="hide-scrollbar flex h-[340px]w-full items-start justify-start gap-8 overflow-x-auto lg:h-[400px] xl:h-[640px]">
            <CampSite 
                backgroundImage="bg-bg-img-1"
                title="Putuk Truno Camp"
                subtitle="Prigen, Prasuran"
        ...
        <div className="flexEnd mt-10 px-6 lg:-mt-60 lg:mr-6">
            <div className="bg-green-50 p-8 lg:max-w-[500px] xl:max-w-[734px] xl:rounded-5xl xl:px-16 xl:py-20 relative w-full overflow-hidden rounded-xl">
                <h2 className="regular-24 md:regular-32 2xl:regular-64 capitalize text-white">
                    <strong className="text-bold">Feeling Lost</strong> And Not Knowing The Way?
                </h2>
